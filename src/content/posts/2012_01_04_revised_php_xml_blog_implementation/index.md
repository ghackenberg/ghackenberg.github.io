...
icon:
  src: "./content.png"
  title: "Revised PHP/XML Blog Implementation - Content illustration"
  description: "Content illustration from Revised PHP/XML Blog Implementation"
---
...
[![Main folders illustration from Revised PHP/XML Blog Implementation](./main_folders.png "Revised PHP/XML Blog Implementation - Main folders illustration")](./main_folders.png)
...
[![Content illustration from Revised PHP/XML Blog Implementation](./content.png "Revised PHP/XML Blog Implementation - Content illustration")](./content.png)
...
[![Controller illustration from Revised PHP/XML Blog Implementation](./controller.png "Revised PHP/XML Blog Implementation - Controller illustration")](./controller.png)
...
[![Model illustration from Revised PHP/XML Blog Implementation](./model.png "Revised PHP/XML Blog Implementation - Model illustration")](./model.png)
...
[![Script illustration from Revised PHP/XML Blog Implementation](./script.png "Revised PHP/XML Blog Implementation - Script illustration")](./script.png)
...
[![Theme illustration from Revised PHP/XML Blog Implementation](./theme.png "Revised PHP/XML Blog Implementation - Theme illustration")](./theme.png)
...
[![View illustration from Revised PHP/XML Blog Implementation](./view.png "Revised PHP/XML Blog Implementation - View illustration")](./view.png)
