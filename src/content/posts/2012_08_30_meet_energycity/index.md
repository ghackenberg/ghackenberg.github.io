...
<p>
		...
		<p>
			<iframe width="100%" height="80%" src="//www.youtube.com/embed/bpUekKVIfds?feature=player_detailpage" frameborder="0" allowfullscreen="yes">
				<!-- empty -->
			</iframe>
		</p>
		<p>
			In the future we plan to extend our tool chain and develop a more realistic model of <strong>EnergyCity</strong>.
