...
[![Computer illustration from The Hyperkit Software graph library in action](./computer.png)](./computer.png)
[![Wikipedia illustration from The Hyperkit Software graph library in action](./wikipedia.png)](./wikipedia.png)
[![Ibm illustration from The Hyperkit Software graph library in action](./ibm.png)](./ibm.png)
...
[![Hackenberg illustration from The Hyperkit Software graph library in action](./hackenberg.png)](./hackenberg.png)
[![Mueller illustration from The Hyperkit Software graph library in action](./mueller.png)](./mueller.png)
[![Infineon illustration from The Hyperkit Software graph library in action](./infineon.png)](./infineon.png)
