...
icon:
  src: "./files.png"
  title: "Managing/Publishing Your Resume with PHP and XML - Files illustration"
  description: "Files illustration from Managing/Publishing Your Resume with PHP and XML"
---
...
[![Files illustration from Managing/Publishing Your Resume with PHP and XML](./files.png "Managing/Publishing Your Resume with PHP and XML - Files illustration")](./files.png)
[![Xml illustration from Managing/Publishing Your Resume with PHP and XML](./xml.png "Managing/Publishing Your Resume with PHP and XML - Xml illustration")](./xml.png)
...
[![Tabular illustration from Managing/Publishing Your Resume with PHP and XML](./tabular.png "Managing/Publishing Your Resume with PHP and XML - Tabular illustration")](./tabular.png)
...
[![Timeline illustration from Managing/Publishing Your Resume with PHP and XML](./timeline.png "Managing/Publishing Your Resume with PHP and XML - Timeline illustration")](./timeline.png)
