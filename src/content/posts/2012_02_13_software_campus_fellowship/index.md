...
<div class="flow-root my-6">
  <div class="float-right ml-6 mb-4 max-w-[180pt] w-full">
    <img src="./logo.png" alt="Logo detail from Software Campus - A new academic excellence program." title="Software Campus - A new academic excellence program - Logo detail" loading="lazy" decoding="async" class="w-full rounded-xl border border-white/10 shadow-lg" />
  </div>
...
[![Group photo](./group.jpg "Group")](./group.jpg)
