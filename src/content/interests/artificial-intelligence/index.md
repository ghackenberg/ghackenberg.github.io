...
![Text Embeddings, Transformer Attention & KV Caching](./ai-1-embeddings-llm-kvcaching.jpg "Vektoreinbettungen, Transformer Self-Attention und KV-Caching")
...
![Multimodal Generative AI: Image, Audio and Video Synthesis](./ai-2-multimodal-generation.jpg "Multimodal Generative AI")
...
![Agentic AI, Reasoning Loops & Model Context Protocol (MCP)](./ai-3-agentic-reasoning-mcp.jpg "Autonome Agenten-Reasoning-Schleifen und MCP-Integration")
